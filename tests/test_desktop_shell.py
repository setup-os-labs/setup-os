...
class DesktopShellTests(unittest.TestCase):
    ...
    def test_desktop_invokes_setup_os_help_contract(self) -> None:
        ...
        self.assertIn("setup_os_run_local_utility_smoke_test", lib_rs)
        ...
        self.assertIn("setup_os_preview_portfolio_conversation", lib_rs)
        ...
        self.assertIn("setup_os_write_portfolio_handoff", lib_rs)
        self.assertIn("setup_os_review_portfolio_handoff_guidance", lib_rs)
        ...
        self.assertIn("setup_os_review_portfolio_memory_update_report", lib_rs)
        self.assertIn("setup_os_review_portfolio_functional_evolution_report", lib_rs)
        self.assertIn("setup_os_review_portfolio_evolution_review_packet", lib_rs)
        self.assertIn("setup_os_review_portfolio_extractor_rollback", lib_rs)
        self.assertIn("setup_os_review_portfolio_extraction_observability", lib_rs)
        ...
        self.assertIn("Setup OS local utility smoke test", lib_rs)
        self.assertIn('"smoke_local_utility.py"', lib_rs)
        ...
        self.assertIn("Portfolio conversation preview", lib_rs)
        self.assertIn("No files were imported or mutated.", lib_rs)
        self.assertIn("Ticker-like tokens", lib_rs)
        self.assertIn("count_keyword", lib_rs)
        self.assertIn('"report.py"', lib_rs)
        self.assertIn('"health.py"', lib_rs)
        self.assertIn('"handoff.py"', lib_rs)
        self.assertIn("Portfolio local utility handoff", lib_rs)
        self.assertIn("Portfolio handoff guidance", lib_rs)
        self.assertIn("format_handoff_guidance", lib_rs)
        self.assertIn("extract_markdown_section", lib_rs)
        self.assertIn("No local utility handoff yet.", lib_rs)
        self.assertIn('"handoff.md"', lib_rs)
        ...
        self.assertIn('"memory_update_report.md"', lib_rs)
        self.assertIn("Portfolio Memory Update Report review", lib_rs)
        self.assertIn("format_memory_update_report_review", lib_rs)
        self.assertIn("review-only; nothing is promoted automatically", lib_rs)
        self.assertIn('"functional_evolution_report.md"', lib_rs)
        self.assertIn("Portfolio Functional Evolution Report review", lib_rs)
        self.assertIn("format_functional_evolution_report_review", lib_rs)
        self.assertIn("not active; approval must create a versioned proposal first", lib_rs)
        self.assertIn('"review_packet.py"', lib_rs)
        self.assertIn('"review_packet.md"', lib_rs)
        self.assertIn("Portfolio Evolution Review Packet", lib_rs)
        self.assertIn("format_evolution_review_packet", lib_rs)
        self.assertIn("Present artifacts", lib_rs)
        self.assertIn('"extractor_versions.jsonl"', lib_rs)
        self.assertIn('"extractor_rollback_plan.md"', lib_rs)
        self.assertIn("Portfolio extractor rollback review", lib_rs)
        self.assertIn("format_extractor_rollback_review", lib_rs)
        self.assertIn("Tracked extractor files in latest snapshot", lib_rs)
        self.assertIn('"extraction_observability.md"', lib_rs)
        self.assertIn("Portfolio extraction observability", lib_rs)
        self.assertIn("No extraction observability report yet.", lib_rs)
        ...
        self.assertIn("Local utility handoff", lib_rs)
    ...
    def test_desktop_ui_accepts_portfolio_output_path(self) -> None:
        ...
        self.assertIn("currentPrimaryView", app)
        self.assertIn("Current view", app)
        self.assertIn("activePrimaryNav === \"agents\"", app)
        self.assertIn("activePrimaryNav === \"imports\"", app)
        self.assertIn("activePrimaryNav === \"proposals\"", app)
        self.assertIn("activePrimaryNav === \"inbox\"", app)
        self.assertIn("visible-path-grid", app)
        ...
        self.assertIn("runLocalUtilitySmokeTest", app)
        ...
        self.assertIn("previewPortfolioConversation(conversationPath)", app)
        self.assertIn("Preview conversation", app)
        ...
        self.assertIn("Runtime log", app)
        self.assertIn("writePortfolioHandoff(portfolioOutputPath)", app)
        self.assertIn("Write handoff", app)
        self.assertIn("reviewPortfolioHandoffGuidance(portfolioOutputPath)", app)
        self.assertIn("Review guidance", app)
        ...
        self.assertIn("reviewPortfolioMemoryUpdateReport(portfolioOutputPath)", app)
        self.assertIn("Review memory report", app)
        self.assertIn("reviewPortfolioFunctionalEvolutionReport(portfolioOutputPath)", app)
        self.assertIn("Review functional evolution", app)
        self.assertIn("reviewPortfolioEvolutionReviewPacket(portfolioOutputPath)", app)
        self.assertIn("Review evolution packet", app)
        self.assertIn("reviewPortfolioExtractorRollback(portfolioOutputPath)", app)
        self.assertIn("Review rollback", app)
        ...
        self.assertIn("runLocalUtilitySmokeTest", setup_os)
        self.assertIn('"setup_os_run_local_utility_smoke_test"', setup_os)
        self.assertIn("checkDesktopReadiness", setup_os)
        self.assertIn("resetPortfolioWorkspace", setup_os)
        self.assertIn("previewPortfolioConversation", setup_os)
        ...
        self.assertIn("reviewPortfolioMemoryUpdateReport", setup_os)
        self.assertIn("reviewPortfolioFunctionalEvolutionReport", setup_os)
        self.assertIn("reviewPortfolioEvolutionReviewPacket", setup_os)
        self.assertIn("reviewPortfolioExtractorRollback", setup_os)
        self.assertIn("reviewPortfolioExtractionObservability", setup_os)
        self.assertIn("getPortfolioSummary", setup_os)
        self.assertIn("writePortfolioHandoff", setup_os)
        self.assertIn("reviewPortfolioHandoffGuidance", setup_os)
        ...
        self.assertIn('"setup_os_preview_portfolio_conversation", { conversationPath }', setup_os)
        ...
        self.assertIn('"setup_os_write_portfolio_handoff", { agentDir }', setup_os)
        self.assertIn('"setup_os_review_portfolio_handoff_guidance", { agentDir }', setup_os)
        ...
        self.assertIn(".primary-view-heading", styles)
        self.assertIn(".visible-path-grid", styles)
