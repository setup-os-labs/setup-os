...
class DesktopShellTests(unittest.TestCase):
    ...
    def test_desktop_invokes_setup_os_help_contract(self) -> None:
        ...
        self.assertIn("setup_os_read_desktop_action_log", lib_rs)
        ...
        self.assertIn("CREATE_NO_WINDOW", lib_rs)
        self.assertIn("hidden_command", lib_rs)
        self.assertIn("run_logged_command", lib_rs)
        self.assertIn("desktop-actions.md", lib_rs)
        self.assertIn("desktop-actions.jsonl", lib_rs)
        self.assertIn("SETUP_OS_APP_DATA_DIR", lib_rs)
        self.assertIn("Desktop action log", lib_rs)
    ...
    def test_desktop_ui_accepts_portfolio_output_path(self) -> None:
        ...
        self.assertIn("Portfolio OS: {currentPrimaryView.title}", app)
        self.assertIn("topbar-subtitle", app)
        self.assertIn('activePrimaryNav === "agents" && (\n            <section className="onboarding-shell"', app)
        ...
        self.assertNotIn('className="surface-tabs"', app)
        ...
        self.assertIn("readActionLog", app)
        self.assertIn("readDesktopActionLog", app)
        self.assertIn("Action log", app)
        ...
        self.assertIn("readDesktopActionLog", setup_os)
        self.assertIn('"setup_os_read_desktop_action_log"', setup_os)
