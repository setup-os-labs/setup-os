...
| SO-101 | todo | Codex | `codex/weekly-memory-update-report` | Add weekly Portfolio Memory Update Report artifact | Saved finance conversations produce evidence-linked facts, preferences, open loops, decisions, risk rules, tax notes, and watchlist drafts without mutating policy |
