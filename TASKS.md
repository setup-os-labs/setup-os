...
| SO-092 | review | Codex | `codex/local-utility-handoff` | Add generated local utility handoff | Generated agents can write `handoff.md` with readiness, runtime, import, memory draft, and next-step status for a laptop or always-on node |
