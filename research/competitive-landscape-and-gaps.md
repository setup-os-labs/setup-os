...
| Output | Postgres, auth, APIs, storage, realtime | Portfolio OS (first output), Career OS, Health OS, custom agents, and optional blueprint templates for future verticals |
