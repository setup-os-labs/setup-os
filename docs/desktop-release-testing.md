...
Before installing an artifact, create a local evidence file from the manifest:
...
Evidence files are written under `release-evidence/` and ignored by git. Use them for screenshots, copied app output, pass/fail notes, and follow-up tasks.
...
- Run `Review memory report`, `Review functional evolution`, `Review evolution packet`, and `Review rollback`.
- Fill in the installed-app smoke evidence file.
