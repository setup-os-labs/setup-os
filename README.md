...
- Current adapters: Markdown/TXT conversation import, read-only holdings, transactions, and cash CSV import, console notifications, local notification inbox, optional disabled-by-default ntfy push.
