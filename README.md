...
- Current adapters: Markdown/TXT conversation import, read-only holdings, transactions, cash, and watchlist CSV import, console notifications, local notification inbox, optional disabled-by-default ntfy push.
