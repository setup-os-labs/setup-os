...
- Current adapters: Markdown/TXT conversation import, read-only holdings CSV snapshot import, console notifications, local notification inbox, optional disabled-by-default ntfy push.
