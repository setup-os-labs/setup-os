...
- Current adapters: Markdown/TXT conversation import, read-only holdings and transactions CSV import, console notifications, local notification inbox, optional disabled-by-default ntfy push.
